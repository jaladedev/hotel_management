...
const NAV_ITEMS = [
  ...
  { href: '/dashboard/fnb/orders', label: 'F&B Orders', roles: ['admin', 'front_desk'] },
  { href: '/dashboard/fnb/tables', label: 'Tables', roles: ['admin', 'front_desk'] },
  { href: '/dashboard/fnb/menu', label: 'Menu', roles: ['admin'] },
  { href: '/dashboard/events', label: 'Events', roles: ['admin', 'front_desk'] },
  ...
  { href: '/dashboard/housekeeping', label: 'Housekeeping', roles: ['admin', 'front_desk', 'housekeeping'] },
